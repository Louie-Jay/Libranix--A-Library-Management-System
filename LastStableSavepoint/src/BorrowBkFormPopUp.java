...
public class BorrowBkFormPopUp extends JPanel{
	...
	public BorrowBkFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Borrow Books"); // title here
		...
		btnBack.addActionListener(new BorrowBkFormPopUpHandler());
	...
	private void loadContentTable() {
		...
		viewBkTable.addMouseListener(new BorrowBkFormPopUp_TableHandler());
	...
	private class BorrowBkFormPopUpHandler implements ActionListener{
	...
	private class BorrowBkFormPopUp_TableHandler extends MouseAdapter{
		JTable source;
