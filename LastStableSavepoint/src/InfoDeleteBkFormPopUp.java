...
public class InfoDeleteBkFormPopUp extends JPanel{
	...
	public InfoDeleteBkFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Delete Info"); // title here
		...
		btnBack.addActionListener(new InfoDeleteBkFormHandler());
	...
	private void loadFooterButtons() {
		...
		btnDelete.setFont(new Font("Arial", Font.PLAIN, 15)); // set font here
		...
		btnDelete.addActionListener(new InfoDeleteBkFormHandler());
		btnCancel.addActionListener(new InfoDeleteBkFormHandler());
	...
	private class InfoDeleteBkFormHandler implements ActionListener{
