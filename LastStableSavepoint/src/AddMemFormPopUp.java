...
public class AddMemFormPopUp extends JPanel{
	...
	public AddMemFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Add Member"); // title here
		...
		btnBack.addActionListener(new AddMemFormHandler());
	...
	private void loadContentForm() {
		...
		content = new JPanel();
		picturebox = new JPanel(new FlowLayout(FlowLayout.CENTER,20,20));
