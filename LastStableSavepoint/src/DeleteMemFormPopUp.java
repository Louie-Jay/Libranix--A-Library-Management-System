...
public class DeleteMemFormPopUp extends JPanel{
	...
	public DeleteMemFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Delete Member"); // title here
		...
		btnBack.addActionListener(new DeleteMemFormHandler());
	...
	private void loadFooterButtons() {
		...
		btnEdit.addActionListener(new DeleteMemFormHandler());
