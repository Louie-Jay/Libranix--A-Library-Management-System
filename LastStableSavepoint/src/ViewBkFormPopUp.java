...
public class ViewBkFormPopUp extends JPanel{
	...
	public ViewBkFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("View Books"); // title here
		...
		btnBack.addActionListener(new ViewBkFormPopUpHandler());
	...
	private void loadContentTable() {
		...
		viewBkTable.addMouseListener(new ViewBkFormPopUp_TableHandler());
	...
	private class ViewBkFormPopUpHandler implements ActionListener{
	...
	private class ViewBkFormPopUp_TableHandler extends MouseAdapter{
		JTable source;
