...
public class RemindViewMemFormPopUp extends JPanel{
	...
	public RemindViewMemFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Remind Members"); // title here
		...
		btnBack.addActionListener(new ViewMemFormPopUpHandler());
	...
	private void loadContentTable() {
		...
		editViewBkTable.addMouseListener(new ViewMemFormPopUp_TableHandler());
	...
	private class ViewMemFormPopUpHandler implements ActionListener{
	...
	private class ViewMemFormPopUp_TableHandler extends MouseAdapter{
		JTable source;
