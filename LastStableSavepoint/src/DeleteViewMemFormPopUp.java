...
public class DeleteViewMemFormPopUp extends JPanel{
	...
	public DeleteViewMemFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Delete Members"); // title here
		...
		btnBack.addActionListener(new DeleteViewMemFormPopUpHandler());
	...
	private void loadContentTable() {
		...
		editViewBkTable.addMouseListener(new DeleteViewMemFormPopUp_TableHandler());
	...
	private class DeleteViewMemFormPopUpHandler implements ActionListener{
	...
	private class DeleteViewMemFormPopUp_TableHandler extends MouseAdapter{
		JTable source;
