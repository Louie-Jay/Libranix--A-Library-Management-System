...
public class DeleteBkFormPopUp extends JPanel{
	...
	//content center
	JPanel content;
	JTable deleteViewBkTable; //test datas over here
	...
	public DeleteBkFormPopUp(JPanel parentPnl) {
	...
	private void loadHeader() {
		...
		headertitle = new JLabel("Delete Books"); // title here
		...
		btnBack.addActionListener(new DeleteViewBkFormPopUpHandler());
	...
	private void loadContentTable() {
		...
		deleteViewBkTable = new JTable(testdata,testcolumn);
		JScrollPane tableScrollPane = new JScrollPane(deleteViewBkTable);
		tableScrollPane.setPreferredSize(new Dimension(1000,560));
		deleteViewBkTable.addMouseListener(new DeleteViewBkFormPopUp_TableHandler());
	...
	private class DeleteViewBkFormPopUpHandler implements ActionListener{
	...
	private class DeleteViewBkFormPopUp_TableHandler extends MouseAdapter{
		JTable source;
