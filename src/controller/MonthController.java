...
public class MonthController {
	...
	private MonthComboBox<String> viewComboBox;
	private String errorStr;
	private String defaultStr;
	
	public MonthController(MonthComboBox paramTextField) {
		viewComboBox = paramTextField;
		viewComboBox.addItemListener(new ChangeHandler());
		viewComboBox.addFocusListener(new FocusHandler());
		viewComboBox.setHoverText("Input valid Month");
		errorStr = "";
		defaultStr = "🗸";
	...
	public void textAlert(){
		...
		if (viewComboBox.isEnabled()) {
			viewComboBox.setHoverText("Select month");
		}
