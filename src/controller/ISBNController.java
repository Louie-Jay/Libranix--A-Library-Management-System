...
public class ISBNController {
	...
	private ISBNTextField viewTextField;
	private String errorStr;
	private String defaultStr;
	
	public ISBNController(ISBNTextField paramTextField) {
		...
		viewTextField.setHoverText("Input valid ISBN");
		errorStr = "";
		defaultStr = "🗸";
	}
	...
	public void validate() {
		...
		if(verifier.overlapsCharLimit(inputTxt, 18)) {
			errorStr = "ISBN digit length up-to 18 only";
			valid = false;
		}
