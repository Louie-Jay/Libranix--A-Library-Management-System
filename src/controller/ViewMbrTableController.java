...
import model.DeleteMbrTableModel;
import model.ViewMbrTableModel;
import view.ContactTextField;
import view.FNameTextField;
import view.IDTextField;
import view.LNameTextField;

public class ViewMbrTableController {
	
	private ViewMbrTableModel model;
	private String errorMsg;
	private HashMap<Integer, String> inputs;
	
	public ViewMbrTableController() {
		model = new ViewMbrTableModel();
