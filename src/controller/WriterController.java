...
public class WriterController {
	...
	private WriterTextField viewTextField;
	private String errorStr;
	private String defaultStr;
	
	public WriterController(WriterTextField paramTextField) {
		...
		viewTextField.setHoverText("Input valid Writer");
		errorStr = "";
		defaultStr = "🗸";
	}
