...
public class TitleController {
	...
	private TitleTextField viewTextField;
	private String errorStr;
	private String defaultStr;
	
	public TitleController(TitleTextField paramTextField) {
		...
		viewTextField.setHoverText("Input valid Title");
		errorStr = "";
		defaultStr = "🗸";
	}
	...
	public void validate() {
		...
		if(verifier.overlapsCharLimit(inputTxt, 139)) {
			errorStr = "Length up-to 139 only";
			valid = false;
		}
