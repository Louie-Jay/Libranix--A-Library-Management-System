...
public class MNameController {
	
	private InputValidator verifier;
	private boolean valid;
	private MNameTextField viewTextField;
	private String errorStr;
	private String defaultStr;
	
	public MNameController(MNameTextField paramTextField) {
		...
		viewTextField.setHoverText("Input valid MiddleName");
		errorStr = "";
		defaultStr = "🗸";
	}
