...
public class InputDialog {
	...
	public InputDialog(JFrame prmParent,String prmMessage) {
	...
	public static Object getInput(JFrame prmParent, String prmMessage) {
		InputDialog input = new InputDialog(prmParent, prmMessage);
		input.setVisible(true);
		Object userInput = input.input;
		return userInput;
	}
	...
	private void init(String prmMessage) {
			...
			dialog.getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnEnter.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						input = new String(txtInput.getText());
						dialog.dispose();
					}
				});
		...
		}
		{
			...
			panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
			{
				...
				lblMessage.setIcon(new ImageIcon(InputDialog.class.getResource("/res/input_fix.png")));
			...
			}
			{
				...
				txtInput.setBorder(new LineBorder(new Color(0, 0, 0)));
				txtInput.setFont(new Font("Lucida Sans Unicode", Font.PLAIN, 11));
				txtInput.setHorizontalAlignment(SwingConstants.CENTER);
				txtInput.setMaximumSize(new Dimension(300, 2147483647));
				txtInput.setMinimumSize(new Dimension(5, 20));
				txtInput.setPreferredSize(new Dimension(5, 10));
				panel.add(txtInput);
