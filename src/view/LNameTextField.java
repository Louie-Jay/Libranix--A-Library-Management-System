...
import controller.LNameController;

public class LNameTextField extends JTextField {
	
	private LNameController controller;
	private Border matteBorder;
	
	public LNameTextField(String txt, int length) {
		super(txt,length);
		controller = new LNameController(this);
